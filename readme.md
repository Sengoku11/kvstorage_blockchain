# example
A simple Cosmos blockchain that can store KV in a state. The data can be retrieved using the Protobuf API. It is built using Cosmos SDK and Tendermint and created with [Ignite CLI](https://ignite.com/cli).
